...
user2.profile = Profile.create! :firstname => 'Tim', :lastname => 'teacher', :skypename => "@greenfrog33", :bio => 'I have a relaxed teaching style and love to go on morning runs.', :uploaded_image => open('https://chatr-app.s3-ap-southeast-2.amazonaws.com/rails-app/default-user-img.png', :average_rating => 3)
...
user5.profile = Profile.create! :firstname => 'Terry', :lastname => 'teacher', :skypename => "@Love2Learn", :bio => 'Native arabic speaker. Let me help you with pronunciation', :uploaded_image => open('https://chatr-app.s3-ap-southeast-2.amazonaws.com/rails-app/default-user-img.png', :average_rating => 5)
user6.profile = Profile.create! :firstname => 'Tara', :lastname => 'teacher', :skypename => "@goodfood19", :bio => 'I speak 9 languages fluently. I can help you learn a new one!', :uploaded_image => open('https://chatr-app.s3-ap-southeast-2.amazonaws.com/rails-app/default-user-img.png',  :average_rating => 4)
